...
def query_llm(prompt: str, client=None, model=None, provider="openai", image_path: Optional[str] = None) -> Optional[str]:
    ...
    Args:
        ...
        model (str, optional): The model to use. Special handling for OpenAI's o3-mini model:
    ...
    Note:
        ...
        Reasoning tokens are only available when using OpenAI's o3-mini model.
    ...
    try:
        ...
        if provider in ["openai", "local", "deepseek", "azure"]:
            ...
            token_usage = TokenUsage(
                ...
                reasoning_tokens=response.usage.reasoning_tokens if model.lower().startswith("o") else None  # Only checks if model starts with "o", e.g., o3-mini, o3-mini-preview, o3-mini-mini, o3, etc. Can update this logic to specific models in the future.
            )
