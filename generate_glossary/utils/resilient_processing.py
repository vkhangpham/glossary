...
The actual implementation has been moved to generate_glossary.processing.resilient.

This file will be removed in a future version. Please update imports to use:
    from generate_glossary.processing import ResilientProcessor, ...
"""
...
warnings.warn(
    "Importing from generate_glossary.utils.resilient_processing is deprecated. "
...
from ..processing.resilient import *