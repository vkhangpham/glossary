...
class Config:
    ...
    INPUT_FILE = os.path.join(BASE_DIR, "data/lv3/raw/lv3_s3_verified_concepts.txt")
    OUTPUT_FILE = os.path.join(BASE_DIR, "data/lv3/raw/lv3_s4_split_concepts.txt")
    META_FILE = os.path.join(BASE_DIR, "data/lv3/raw/lv3_s1_metadata.json")
    SPLIT_META_FILE = os.path.join(BASE_DIR, "data/lv3/raw/lv3_s4_metadata.json")
    BATCH_SIZE = 10
    COOLDOWN_PERIOD = 1
...
def main():
    ...
    try:
        logger.info("Starting compound term splitting process for level 3 concepts")
        ...
        logger.info("Compound term splitting for level 3 completed successfully")
