...
class Config:
    ...
    INPUT_FILE = "../data/lv3/lv3_s1_extracted_concepts.txt"
    META_FILE = "../data/lv3/lv3_s1_metadata.json"
    OUTPUT_FILE = "../data/lv3/lv3_s2_filtered_concepts.txt"
    VALIDATION_META_FILE = "../data/lv3/lv3_s2_metadata.json"
    VENUE_FREQ_THRESHOLD = 2  # Minimum number of venues a concept must appear in

def count_venue_frequencies(
    ...
    # Count appearances across venues
    for concepts in venue_mapping.values():
        # Convert list to set to avoid counting duplicates within same venue
...
def filter_concepts(
    ...
    Args:
        ...
        concept_frequencies: Dictionary mapping concepts to their venue frequency
        threshold: Minimum number of venues a concept must appear in
...
def main():
    ...
    try:
        ...
        concept_frequencies = count_venue_frequencies(venue_mapping)
