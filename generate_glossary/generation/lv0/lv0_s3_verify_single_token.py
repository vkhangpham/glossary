"""Level 0 Step 3: Verify single-word tokens - Simple wrapper version."""

from generate_glossary.generation.wrapper_utils import create_s3_wrapper

# Create the wrapper with Level 0 configuration
main, test = create_s3_wrapper(level=0)
