#!/usr/bin/env python
"""
Simple runner script for lv0_s3 discipline verification prompt optimization.
...
Output:
    ...
    - Optimized prompts saved to data/prompts/lv0_s3_user_latest.json
"""
...
def main():
    """Run the lv0_s3 prompt optimization."""
    print("=" * 60)
    print("LV0_S3 Discipline Verification Prompt Optimization")
    print("=" * 60)
    ...
    if not os.getenv("OPENAI_API_KEY"):
        ...
        print(
            "Please set it in .env file or with: export OPENAI_API_KEY='your-key-here'"
        )
        sys.exit(1)
    ...
    try:
        ...
        from prompt_optimization.optimizers.lv0_s3 import optimize_prompts
        ...
        print("  • data/prompts/lv0_s3_system_latest.json")
        print("  • data/prompts/lv0_s3_user_latest.json")
        print()
